...
template <class T> class CDynamicArray :public CSGObject
{
	public:
		 ...
		 */
		CDynamicArray(int64_t p_dim1_size, int64_t p_dim2_size=1, int64_t p_dim3_size=1)
		 ...
		 */
		CDynamicArray(T* p_array, int64_t p_dim1_size, bool p_free_array, bool p_copy_array)
		 ...
		 * @param p_copy_array if array must be copied
		 */
		CDynamicArray(T* p_array, int64_t p_dim1_size, int64_t p_dim2_size,
		 ...
		 */
		CDynamicArray(T* p_array, int64_t p_dim1_size, int64_t p_dim2_size,
						int64_t p_dim3_size, bool p_free_array, bool p_copy_array)
		 ...
		 * @param p_dim3_size dimension 3
		 */
		CDynamicArray(const T* p_array, int64_t p_dim1_size=1, int64_t p_dim2_size=1, int64_t p_dim3_size=1)
		 ...
		 */
		inline int64_t set_granularity(index_t g)
		{
		 ...
		 */
		inline T& element(T* p_array, index_t idx1, index_t idx2, index_t idx3, int64_t p_dim1_size, int64_t p_dim2_size)
		{
		 ...
		 */
		inline void set_array(T* p_array, int64_t p_num_elements,
							  index_t array_size)
		{
		 ...
		 */
		inline void set_array(const T* p_array, int64_t p_size)
		{
