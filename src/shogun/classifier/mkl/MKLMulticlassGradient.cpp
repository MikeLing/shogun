...
void MKLMulticlassGradient::gengammagradient( ::std::vector<float64_t> & gammagradient ,const ::std::vector<float64_t> & gammas,const int64_t dim)
{
...
float64_t MKLMulticlassGradient::objectives(const ::std::vector<float64_t> & weights, const index_t index)
{
	assert(index>=0);
